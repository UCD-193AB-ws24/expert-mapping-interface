...
//  * - A search bar and filters in the right panel
...
//     <select 
//       id="location-filter"
//       className="block appearance-none w-full bg-white border border-gray-300 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:border-gray-500 focus:ring-2 focus:ring-[#022851]"
//     >
...
//               <button 
//                 className="w-full bg-[#022851] hover:bg-[#033a73] text-white font-medium py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#022851]"
